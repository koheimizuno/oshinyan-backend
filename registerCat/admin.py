...
class ShopAdmin(admin.ModelAdmin):
    list_display = ['id', 'is_public', 'shop_type', 'shop_name', 'prefecture', 'address', 'nearest_station', 'phone', 'business_time', 'rest_day', 'url', 'shop_with_images', 'created_date']
...
class CatAdmin(admin.ModelAdmin):
    list_display = ['id', 'is_public', 'shop', 'cat_name', 'display_character', 'favorite_things', 'attendance', 'formatted_description', 'cat_with_images', 'cat_with_images_admin', 'design_test', 'created_date']
